...
type BaseDialogProps = Required<Pick<DialogProps, "open" | "onOpenChange">>;
...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { isClosable?: boolean }
