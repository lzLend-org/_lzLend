...
type UseListPoolOptions = Omit<UseMutationOptions<string, Error, void, unknown>, "mutationFn"> & {
  pool: Pool;
};

export function useListPool({ pool, ...options }: UseListPoolOptions) {
  ...
  return useMutation({
    ...
    onSuccess(txnHash, variables, context) {
      ...
      toast({
        title: "List Successfull!",
        description: "Your list was successfull",
